...
class Algo(ABC):
    ...
    def train(self, env_name: str, map_name: str, architecture, 
              stop_criteria: dict = None, GPUs: int = 0, Checkpoints_freq: int = 1, env_kwargs: dict = None) -> MARLlibPolicy:
        """
        ...
        Args:
            ...
            env_kwargs (dict): Arguments supplémentaires pour la création de l'environnement.
